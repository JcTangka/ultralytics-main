...
if __name__ == '__main__':
    ...
    model = YOLO('../cfg/models/v8/yolov8-GAM.yaml').load('D://Work//PYworks//ultralytics-main//ultralytics//yolov8n.pt')  # GAM
    ...
    model.train(data='../cfg/datasets/All_my_school_dataset.yaml', epochs=500,project='./runs/detect',name='GAMTest3_mydataset_mypt_NetLocChange',
                imgsz=640,conf=0.1,iou=0.6,patience=200)
